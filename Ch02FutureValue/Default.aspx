    ...
    <main>
        <form id="form1" runat="server" class="form-horizontal" role="form">
            <div class="form-group">
                <label class="control-label col-sm-3 col-xs-12" for="ddlMonthlyInvestment">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3 col-xs-12" for="txtInterestRate">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3 col-xs-12" for="txtYears">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3 col-xs-12" for="lblFutureValue">
                    Future Value:</label>
